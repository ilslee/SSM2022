...
namespace ssm.game.appearance{
    public class GaugeManager : MonoBehaviour
    {
        ...
        public void UpdateGauge(float v){
            if(gaugeColor.Count < gaugeLength){
                Debug.LogError("GaugeManager.SetGauge : Not enough color variation" + gaugeColor.Count);
                return;
            }
            ...
            // Debug.Log("Gauge Group : " + gaugeGroupID + " / Fill count : " + gaugeFillcount);
            //set gauge color
        ...
        public void SetValue(float v = 0f){
        ...
        /*
        // 수치 업데이트는 Info Manager에서 담당하기로 함 250528
